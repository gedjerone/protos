...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Successfully registered user's ID
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // User's email to login
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // User's password to login
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // App's id to login to
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the loggined user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x13, 0x67, 0x65, 0x64, 0x6a, 0x65, 0x72, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
